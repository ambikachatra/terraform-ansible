    ...
    >
      ...
      <div className="container text-center text-white position-relative z-1">
        ...
        <h1 className="display-4 fw-bold mb-3 animate-fade">
          Hi, I’m <span className="highlight-name">Ambika Chatra</span>
        </h1>

        <h2 className="typing-text mb-4 fs-4">
          <TypeAnimation
            sequence={[
              'Cloud Engineer', /* Give your designations suppose you are devops engineer, cybersecruity engineer, frontend engineer, backend engineer, web developer, flutter developer, .net developer .....*/
              2000,
              'DevOps Engineer',
              2000,
        ...
        <a
          href={resumePDF}
          download="DevopsResume - 2025.pdf" /* your resume name with extension of .pdf*/
